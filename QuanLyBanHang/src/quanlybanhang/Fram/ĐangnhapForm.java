 ...
 * @author Admin
 */
public class ĐangnhapForm extends javax.swing.JFrame {

    /**
     * Creates new form ĐangnhapForm
     */
    public ĐangnhapForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel20.setText("(*)- Nhập thông tin bắt buộc");
         ...
         if(txtUser.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(this, "Vui lòng đăng nhập mật khẩu");
                ...
                if(Password.getText().equals("BTL")){
                        ...
                        HomePage_QuanLy ql=new HomePage_QuanLy();
                        ql.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ĐangnhapForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ĐangnhapForm().setVisible(true);
            }
        });
    }
